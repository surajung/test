export default function MobileKeypadPage() {
  return (
    <main className="tile-parchment min-h-[100dvh]">
      <section className="mx-auto w-full max-w-2xl px-4 pb-40 pt-8 sm:px-6">
        <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
          Mobile Keypad Position Test
        </h2>
        <p className="mt-3 text-zinc-700">
          Scroll and focus the numeric input at bottom. Verify input visibility and
          fixed CTA location when the keyboard appears.
        </p>
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-zinc-200 bg-white/95 px-4 pb-[calc(env(safe-area-inset-bottom)+12px)] pt-3 backdrop-blur sm:px-6">
        <div className="mx-auto w-full max-w-2xl space-y-3">
          ...
          <input
            ...
            className="h-12 w-full rounded-full border border-zinc-300 px-4 text-base"
          />
